...
flowchart TB
    ...
    %% Styling
    classDef db fill:#ff99ff,stroke:#333,stroke-width:1px;
    classDef cache fill:#ffff99,stroke:#333,stroke-width:1px;
    classDef queue fill:#99ffff,stroke:#333,stroke-width:1px;
    class TSPG db
    class TSCache cache
